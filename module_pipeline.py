...
_PAGE_CSS = """
:root {
  --bg: #ffffff; --surface: #f6f5f0; --border: #e2dfd6;
  --text: #1a1917; --muted: #6b6a65; --accent: #185fa5;
  --accent-light: #e6f1fb; --note-bg: #e1f5ee; --note-border: #0F6E56;
  --warn-bg: #faeeda; --warn-border: #BA7517;
  --key-bg: #EEEDFE; --key-border: #534AB7;
  --danger-bg: #fcebeb; --danger-border: #A32D2D;
}
@media (prefers-color-scheme: dark) {
  :root { --bg: #1a1917; --surface: #242320; --border: #3a3835;
    --text: #e8e6df; --muted: #9a9890; --accent-light: #042c53;
    --note-bg: #04342c; --warn-bg: #412402; --key-bg: #26215c; }
}
...
h1 { font-size: 1.8rem; font-weight: 600; margin-bottom: 0.2rem; line-height: 1.2; }
h2 { font-size: 1.25rem; font-weight: 600; margin-top: 2.5rem; padding-bottom: 0.4rem;
...
.callout-danger  { background: var(--danger-bg); border-left: 4px solid var(--danger-border); }
.callout-label { font-weight: 700; font-size: 0.78rem; text-transform: uppercase;
  letter-spacing: 0.06em; margin-bottom: 0.35rem; }
.objectives { background: var(--surface); border-radius: 8px;
  padding: 1.25rem 1.5rem; margin: 1.5rem 0; }
.objectives ul { margin: 0.5rem 0 0; padding-left: 1.4rem; }
.lesson-summary { background: var(--accent-light); border-radius: 8px;
  padding: 1.25rem 1.5rem; margin: 2.5rem 0 1rem; }
.lesson-summary h3 { margin-top: 0; color: var(--accent); font-size: 1rem; }
.image-needed { border: 2px dashed var(--border); border-radius: 8px;
